    ...
    >
      ...
      <div className="relative h-52">
        ...
        {role === "backer" && (
          ...
          >
            <FaBookmark className={isBookmarked ? "text-[#2C7865]" : "text-gray-400"} />
          </button>
        )}
      </div>
      ...
      <div className="p-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-2.5">
          <div className="bg-[#2C7865] h-2.5 rounded-full" style={{ width: `${progress}%` }} />
        </div>
        ...
        {role === "backer" && (
          <motion.button
            ...
            className={`mt-4 w-[50%] px-6 py-2 rounded-full ${
              campaignStatus === "active" ? "bg-[#2C7865] text-white" : "bg-gray-300 text-gray-500"
            }`}
          >

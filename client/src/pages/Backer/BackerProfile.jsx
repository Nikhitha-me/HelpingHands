...
const BackerProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f6] text-[#90D26D] p-8 ">
        ...
        <div className="p-6 rounded-lg shadow-lg bg-white/10">
          ...
          <div className="mb-4">
            ...
            {isEditing ? (
              <input
                ...
                className="w-full p-2 text-[#90D26D] rounded-lg bg-white/80 border-2  outline-none hover:border-[#90D26D] transition duration-300"
              />
            ) : (
          ...
          <div className="mb-4">
            ...
            {isEditing ? (
              <textarea
                ...
                value={profile.bio}
                onChange={handleInputChange}
                className="w-full p-2 text-[#1a1a2e] rounded-lg bg-white/80 border-2  outline-none hover:border-[#90D26D] transition duration-300"
              />
            ) : (
          ...
          <div className="flex justify-end mt-6">
            {isEditing ? (
              <button
                onClick={handleSave}
                className="bg-[#90D26D] text-white px-6 py-2 rounded-full hover:bg-[#90D26D] transition duration-300"
              >
                Save 
              </button>
            ) : (

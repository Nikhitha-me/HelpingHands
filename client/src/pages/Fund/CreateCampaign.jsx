...
const CreateCampaign = () => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen bg-gradient-to-r from-[#2C7865] to-[#004445] p-8 pt-24"
    >
      <motion.div
        initial={{ y: 20 }}
        animate={{ y: 0 }}
      ...
      >
        <div className="px-8 py-6 bg-[#90D26D] text-white">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                } focus:border-[#90D26D] focus:ring-1 focus:ring-[#90D26D] transition-all outline-none`}
              />
            ...
            <div>
              ...
              <input
                ...
                } focus:border-[#90D26D] focus:ring-2 focus:ring-[#90D26D] transition-all outline-none`}
              />
              ...
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="block w-full text-sm text-gray-500
                    ...
                    file:bg-[#90D26D] file:text-white
                    hover:file:bg-[#004445] transition-colors"
                  accept="image/*"
                />
                {formData.image && (
                  <motion.img
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 px-6 bg-gradient-to-r from-[#2C7865] to-[#004445] text-white 

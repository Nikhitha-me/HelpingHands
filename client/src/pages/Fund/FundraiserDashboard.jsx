...
const FundraiserDashboard = () => {
  ...
  if (loading) {
    return (
      ...
      >
        <div className="w-12 h-12 border-t-2 border-b-2 border-[#90D26D] rounded-full animate-spin"></div>
      </motion.div>
    );
  }

  return (
    <div className="min-h-screen bg-[#f6f6f6] text-[#90D26D] p-8 mt-[80px]">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        >
          ...
          <div className="text-3xl font-bold text-[#90D26D]">

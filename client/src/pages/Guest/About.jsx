...
const About = () => {
  ...
  return (
    <>
      <div className="min-h-screen bg-white text-[#90D26D] px-6 md:px-20 py-12 ">
        <motion.div
          initial="hidden"
          animate="visible"
          variants={fadeInUp}
          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
              {[
                {
                  icon: (
                    <FaLightbulb className="text-4xl mx-auto mb-4 text-[#90D26D]" />
                  ),
                ...
                {
                  icon: (
                    <FaHandHoldingHeart className="text-4xl mx-auto mb-4 text-[#90D26D]" />
                  ),
                ...
                {
                  icon: (
                    <FaUsers className="text-4xl mx-auto mb-4 text-[#90D26D]" />
                  ),
        ...
        <div className="container px-4 py-16 mx-auto text-center">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="bg-[#90D26D] text-white px-8 py-3 rounded-full hover:bg-[#004445] transition duration-300"

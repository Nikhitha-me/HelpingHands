      ...
      <div className="min-h-screen bg-white text-[#90D26D] px-6 md:px-20 py-12 ">
        ...
        <div className="container grid grid-cols-1 gap-8 px-4 py-12 mx-auto text-center md:grid-cols-3">
          {[
            {
              icon: (
                <FaPhone className="text-4xl mx-auto mb-4 text-[#90D26D]" />
              ),
              title: "Call Us",
              info: "+123 456 7890",
            },
            {
              icon: (
                <FaEnvelope className="text-4xl mx-auto mb-4 text-[#90D26D]" />
              ),
              title: "Email Us",
            ...
            {
              icon: (
                <FaMapMarkerAlt className="text-4xl mx-auto mb-4 text-[#90D26D]" />
              ),
              title: "Visit Us",

...
const LoginPage = () => {
  ...
  return (
    ...
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    className="min-h-screen bg-gradient-to-r from-[#2C7865] to-[#004445] flex items-center justify-center"
  >
    <motion.form
      ...
      noValidate
    >
      <h2 className="mb-8 text-3xl font-bold text-center text-[#90D26D]">
        Welcome Back
      </h2>
      ...
      <div className="space-y-6">
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <div className="relative">
            ...
            <input
              type="email"
              {...register("email")}
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 outline-none focus:border-[#90D26D] focus:ring-2 focus:ring-[#90D26D] transition-all "
        ...
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
          ...
          <div className="relative">
            ...
            <input
              type="password"
              {...register("password")}
              className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 outline-none focus:border-[#90D26D] focus:ring-2 focus:ring-[#90D26D]/20 transition-all"
            />
          </div>
          {errors.password && (
              <motion.p
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.98 }}
          type="submit"
          className="w-full py-3 px-6 bg-gradient-to-r from-[#2C7865] to-[#004445] text-white rounded-lg font-semibold shadow-lg hover:shadow-xl transition-all"
        >
          Sign In
        </motion.button>
      </div>
      ...
      <div className="mt-6 text-center">
        <a
          ...
          className="text-sm text-[#90D26D] hover:underline"
        >
          Forgot Password?
        </a>
      </div>
      ...
      <p className="mt-6 text-center text-gray-600">
        ...
        <a
          href="/register"
          className="text-[#90D26D] font-semibold hover:underline underline-offset-4"
        >
          Create Account
        </a>
      </p>

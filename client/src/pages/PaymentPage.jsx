...
const PaymentPage = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-[#2C7865] to-[#004445]">
      <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
        ...
        <form onSubmit={handlePayment} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 text-white bg-[#90D26D] rounded-md hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          >
            Donate
          </button>
        </form>

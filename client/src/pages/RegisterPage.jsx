          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className="relative">
              ...
              <input
                type="text"
                {...formRegister("name")}
                className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:border-[#90D26D] focus:ring-2 focus:ring-[#90D26D]/20 transition-all"
              />
            </div>
            {errors.name && (
              <motion.p
